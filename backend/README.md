...
## Project Structure
    ...
    ├── testapiautostoryboa_57535  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_57535`
...
2. Clone this repo and `cd testapiautostoryboa_57535`
